...
public class CONLLUPReader {
	...
	private ArrayList<String> metaOrder;
	...
	private void init(Path fpath,String[] sentenceMeta) throws IOException {
		...
		metaOrder=new ArrayList<String>(10);
	...
	/**
	 * @return the sentenceMeta
	 */
	public HashMap<String, Boolean> getSentenceMeta() {
		return sentenceMeta;
	}
	...
	/**
	 * @return the metaOrder
	 */
	public ArrayList<String> getMetaOrder() {
		return metaOrder;
	}
}
